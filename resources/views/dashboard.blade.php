            ...
            <div class="card overflow-hidden">
                <div class="card-body">
                    ...
                    <div class="row align-items-start">
                        <div class="col-md-7">
                            <p class="text-secondary fs-13px mb-3 mb-md-0">Revenue is the income that a
                                business has from its normal business activities, usually from the sale of
                                goods and services to customers.</p>
                        </div>
        ...
        <div class="col-lg-7 col-xl-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-secondary">Sales are activities related to selling or the number of
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <div>
                                <label
                                    class="d-flex align-items-center fs-10px text-uppercase fw-bolder"><span
